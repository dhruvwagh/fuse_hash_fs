...
Usage:
    python thesis_plotter.py [results_file] [output_directory]
    
    results_file:      Path to the JSON results file (default: storage_results/storage_simulation_results.json)
    output_directory:  Directory to save plots (default: thesis_plots)
...
def main():
    ...
    if not os.path.exists(results_file):
        ...
        print("Please specify a valid path to the simulation results JSON file.")
        sys.exit(1)
